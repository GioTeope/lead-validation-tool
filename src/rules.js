...
const SCRUBBED_COMPANIES = [
  ...
  'Independent',
  'Independant',
  'N/A', 'n/a', 'None', 'Nil', 'Nothing',
  'No organization', 'No affiliation', 'Not applicable',
  'Not affiliated', 'Self', 'Own',
  'Retired', 'Homemaker',
  'WFH', 'TBD', 'TBH',
  'xxx', 'zzz', 'asdf', 'qwerty',
  'sample', 'placeholder', 'testing'
];
...
const SCRUBBED_COMPANY_KEYWORDS = [
  ...
  'not working',
  'not in a company',
  'uni student', 'university student', 'college student',
  'school student', 'phd student', 'phd candidate',
  'masters student', 'undergrad', 'undergraduate',
  'postgraduate', 'intern', 'internship',
  'trainee', 'apprentice',
  'pigiste', 'freiberufler', 'freiberuflich',
  'libero professionista', 'autonomo', 'autónomo',
  'open to work', 'seeking employment', 'recently laid off',
  'on my own', 'working for myself', 'own business',
  'my own company', 'i work from home',
  'remote worker', 'work from home',
  'no organization', 'no affiliation', 'not affiliated'
];
